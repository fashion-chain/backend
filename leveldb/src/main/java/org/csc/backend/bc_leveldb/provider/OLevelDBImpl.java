...
import org.brewchain.tools.bytes.BytesComparisons;
...
public class OLevelDBImpl implements ODBSupport, DomainDaoSupport {
	...
	public OLevelDBImpl(String domain, LDatabase dbs) {
		this.domainName = domain;
		this.dbs = dbs;
	}

	public OLevelDBImpl(String domain, LDatabase dbs, LDatabase sdbs) {
		this.domainName = domain;
		this.dbs = dbs;
